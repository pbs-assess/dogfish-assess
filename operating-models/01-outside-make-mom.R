...
MOM <- SS2MOM_dogfish(SSdir = replist, nsim = 50, proyears = 300)
...
saveRDS(multiHist_agg, file.path(#"C:/users/qhuynh/Desktop",
                                 "operating-models", "mom",
                                 paste0("multihist_", model_dir, ".rds")))
