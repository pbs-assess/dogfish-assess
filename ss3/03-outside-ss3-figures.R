...
set_to_plot <- match.arg(set_to_plot, choices = c("growth", "index", "M"))

if (set_to_plot == "growth") {

  # Set A models with growth and maturity scenarios
  mods <- c("A1", "A2_USgrowth", "A3_highmat", "A4_USgrowth_highmat", "A5_highdiscard")
  model_name <- c("(A1) BCgrowth", "(A2) USgrowth", "(A3) BCgrowth, high mat", "(A4) USgrowth, high mat", "(A5) 100% discard m.")
  ...
  model_name <- c("(A1) All indices", "(A6) IPHC + CPUE", "(A6) SYN", "(A7) HBLL")
