...
#
250 # MCeval burn interval
5 # MCeval thin interval
0 # jitter initial parm value by this fraction
2023 # min yr for sdreport outputs (-1 for styr); #_1952
...
4 # Annual_F_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Apical_F's); 4=true F for range of ages; 5=unweighted avg. F for range of ages
 10 10 #_min and max age over which average F will be calculated with F_reporting=4 or 5
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1679075532
