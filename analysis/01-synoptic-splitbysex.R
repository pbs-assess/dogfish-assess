...
saveRDS(ind_f, file = "data/generated/geostat-ind-synoptic-female.rds")
saveRDS(ind_m, file = "data/generated/geostat-ind-synoptic-male.rds")
# saveRDS(ind, file = "data/generated/geostat-ind-male-trim.rds")
# saveRDS(ind, file = "data/generated/geostat-ind-female-trim.rds")

ind_f <- readRDS("data/generated/geostat-ind-synoptic-female.rds")
ind_m <- readRDS("data/generated/geostat-ind-synoptic-male.rds")
