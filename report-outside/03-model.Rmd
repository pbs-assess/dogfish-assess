...
- B1: Estimate an increase in natural mortality starting in 1990 when the pinniped population, and hypothesized predation mortality on dogfish, started to increase [@oleksiuk2018]. The increase is linear year over year. A single additional parameter is estimated.
