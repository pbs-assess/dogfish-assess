...
- Decline of whaling led to increase in Dogfish catches
...
.pull-two-thirds-left[
.small[
- Government eradication programs in late 1950s

- "Killer" trawl boats had trouble catching large amounts of Dogfish

- Switched to subsidies to promote food fishery by 1962

- Largely unsuccessful until Dogfish declines in Europe and Japan opened up markets
]
]
...
.xsmall[
- Restrictions on rockfish in Strait of Georgia and Individual Vessel Quota system led to decline in Dogfish fishing

- Marine Stewardship Council certification (2011); first dogfish fishery; later voluntarily withdrawn
...
- Propose 0.2B<sub>0</sub> as LRP, 0.4B<sub>0</sub> as candidate USR, and F<sub>0.4S0</sub> as removal reference rate
]
...
.tiny[
Rates of decline calculated empirically from population indices (Appendix E)
]
...
- No obvious explanation for challenges fitting Synoptic trawl index
]
...
Old Dogfish have lived through ("integrate over") many years of environmental conditions (Taylor and Galluci 2009) 
...
Regardless of the cause, there are considerably fewer Dogfish in BC outside waters than there were 20 years ago when surveys began.

---
# Conclusions

All population indices have declined over the last 20 years. The steepest declined at 59–71% per decade.
...
It is unclear which model is most plausible in terms of how catch will affect the stock, but even the most optimistic scenarios suggest catches would need to be much lower than the current TAC to obtain stock growth.
...
Minor increase in small dogfish in SYN WCVI survey?

Stock may behave in unexpected ways given we were unable to fit full decline for 2 surveys
...
**<u>D.L Courtney</u>** and **<u>S.A. Pardo</u>** for providing constructive reviews.

**<u>I.G. Taylor</u>** for heroically agreeing to review the document on 1-day's notice (😱).
...
Hardbottom longline survey index for inside waters also declines, although less steeply than outside waters and mostly in shallower waters.

.pull-left[
```{r, out.width="80%"}
include_graphics("assets/img/hbll-ins-n-s-figure.jpg")
```
]

.pull-right[
```{r, out.width="100%"}
include_graphics("assets/img/depth-bin-figure.jpg")
```
]

---

## Delayed effect of 1940s fishery (model A3)

```{r, out.width="80%"}
include_graphics("../figs/dynamic-bubble-A3.png")
```
...
## Delayed effect of 1940s (model A0)
...
## CPUE from last assessment

```{r, out.width="80%"}
include_graphics("~/Downloads/Screenshot of Zotero at Oct 17, 2024 at 10_35_40 AM.jpg")
```
...
```{r, out.width="80%"}
include_graphics("~/Downloads/Screenshot of RStudio at Oct 17, 2024 at 2_42_56 PM.jpg")
```

---

## Revised depletion time series (A0)

```{r, out.width="80%"}
include_graphics("~/Downloads/Screenshot of RStudio at Oct 17, 2024 at 2_39_11 PM.jpg")
```

---

## Revised F/F0.4S0 time series (A0)

```{r, out.width="80%"}
include_graphics("~/Downloads/Screenshot of RStudio at Oct 17, 2024 at 2_38_32 PM.jpg")
```
