...
.tiny[
Rates of decline calculated empirically from spawning biomass estimates or indices (Appendix E)
]
...
Hardbottom longline survey for inside waters also declines, although less steeply than outside waters and mostly in shallower waters.
...
```{r, out.width="60%"}
include_graphics("../figs/length-age-vb-dfo-nwfsc-ex-large-female.png")
```

```{r, out.width="60%"}
include_graphics("../figs/length-age-vb-dfo-nwfsc.png")
```
