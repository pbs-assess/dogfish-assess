...
- Data limited approach with survey and fishery catch (no population model)

### US West Coast

- Age-structured modeling approach similar to this Research Document (Gertseva et al. 2021)
=======
...
>>>>>>> c0982e49998f75ddf93427ae70a9b85bdd7bab52
...
<<<<<<< HEAD
- Spatiotemporal modeling to estimate abundance over a spatial grid of the survey. Approach imputes abundance in missing time/area strata, e.g., for Synoptic survey
- Depth as a fixed effect in standardization
=======
...
=======
###  Why a stock-recruit curve for Dogfish-like species?
...
- Unfished population N = 100 adults, which produce 10 pups/adult, that's 1,000 pups ($S_0$).
- If density-dependent unfished pup survival is 0.6, then we get 600 recruits ($R_0$).
- A population of N = 20 (0.2 $B_0$) produces 200 pups. If steepness were 1 in a closed population, we'd have to conjure 600 recruits from 200 pups.
- Thus, in this example, steepness is capped at 0.33: 200 pups at 0.2 $B_0$ divided by 600 pups at $B_0$.
